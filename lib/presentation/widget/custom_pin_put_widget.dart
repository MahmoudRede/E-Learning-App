import 'package:e_learning_app/helper/decoration_config/pin_put_decoration.dart';
    ...
    return Directionality(
      ...
      child: Pinput(
        defaultPinTheme:defaultPinTheme.copyWith(
          ...
          textStyle: Theme.of(context).textTheme.headline3!.copyWith(color: AppColor.gray,fontWeight: FontWeight.w700, fontSize: FontSize.headline3Size),
        ...
        focusedPinTheme: focusedPinTheme.copyWith(
          height: SizeConfig.height*0.062,
          width: SizeConfig.height*0.07,
          textStyle: Theme.of(context).textTheme.headline3!.copyWith(color:AppColor.black,fontWeight: FontWeight.w500, fontSize: SizeConfig.pinPutTextSize),
          decoration: BoxDecoration(
            color: AppColor.white,
            border: Border.all(
