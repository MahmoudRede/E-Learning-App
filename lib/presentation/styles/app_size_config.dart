...
class SizeConfig extends StatelessWidget {
  ...
  static double headline1Size = SizeConfig.height * 0.0395 ; //32 px
//#endregion

  //#region headline 2 Size
  static double headline2Size = SizeConfig.height * 0.0344; // 28 px
//#endregion

  //#region headline 3 Size
  static double headline3Size = SizeConfig.height * 0.0295; // 24 px
//#endregion

  //#region headline 4 Size
  static double headline4Size = SizeConfig.height * 0.0221 ; //18 px
//#endregion
